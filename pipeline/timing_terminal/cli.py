...
def main() -> None:
    ...
    # Show recent scores (end of window) not beginning (which may have NaN fallbacks)
    recent_scores = [s["value"] for s in payload.get("lsd", payload.get("phaseScore", []))[-10:]]
    print(f"Recent LSD scores (last 10): {recent_scores}")
