...
- [ ] **Task 1 – Bootstrap Python package structure for pipeline** (AC: 1, 2, 6)  
...
- [ ] **Task 2 – Implement core data models and JSON schema** (AC: 1, 2, 4)  
...
- [ ] **Task 3 – Implement deterministic phase-score function using fixture data** (AC: 2, 3, 4)  
...
- [ ] **Task 4 – Wire CLI entrypoint for end-to-end run** (AC: 1, 2, 5)  
...
- [ ] **Task 5 – Integration tests for `chart-data.json`** (AC: 1, 2, 4)  
  - [ ] Add integration tests under `pipeline/tests/integration/` that:
...
- [ ] **Task 6 – Minimal logging and developer documentation** (AC: 5, 6)  
  - [ ] Add simple, structured logging (or stdout messages) summarizing each run.
...
_(To be filled by QA agent after validating implementation.)_
